...
Для этого в VISTA: Панель управления > Учётные записи пользователей > Включение или отключение контроля учётных записей (UAC) > убираем галочку > Перезагружаемся.
В WINDOWS7: Панель управления > Учётные записи пользователей > Изменение параметров контроля учётных записей > Понижаем ползунком уровень до крайнего > Перезагружаемся.
...
**Источник:** https://4pda.ru/forum/index.php?showtopic=301887